...
<div class="row">
    <form method="post" action="/rda/save">
        ...
        <div class="form-group">
            ...
            <input required name="name_rda" id="name_rda" class="form-control" type="text" placeholder="Миколаїв місто"
                   value="<?php echo $data['name_rda'] ?>">
        </div>
        <div class="form-group">
            <label for="name_admin_services">Назва Центру надання адміністративних послуг РДА/МВК</label>
            <input required id="name_admin_services" name="name_admin_services" class="form-control" type="text"
        ...
        <div class="form-group">
            ...
            <input required name="email" id="email" class="form-control" type="text" placeholder="email@mail.com" value="<?php echo $data['email'] ?>">
        </div>
